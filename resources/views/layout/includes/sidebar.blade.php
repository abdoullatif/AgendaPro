    <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="{{ route('home') }}">AgendaPro</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="{{ route('home') }}">AP</a>
          </div>
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Rendez-vous</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route('creneau.add') }}">Reserver</a></li>
                <li><a class="nav-link" href="{{ route('creneau') }}">Rendez-vous</a></li>
                <li><a class="nav-link" href="{{ route('calendrier') }}">Calendrier</a></li>
              </ul>
            </li>
            <!--
  ...
  -->
            ...
            <li class="dropdown">
              <!--
              <a href="#" class="nav-link has-dropdown"><i class="fas fa-th-large"></i> <span>Clients</span></a>
              <ul class="dropdown-menu">
  ...
  -->
            <li class="dropdown">
              <a href="#" class="nav-link has-dropdown"><i class="far fa-file-alt"></i> <span>Clients</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route('client.add') }}">Creer un compte</a></li>
                <li><a class="nav-link" href="{{ route('client') }}">Client</a></li>
            ...
            <li class="dropdown">
              <a href="#" class="nav-link has-dropdown"><i class="far fa-user"></i> <span>Administrateur</span></a>
              <ul class="dropdown-menu">
              <li><a href="{{ route('admin.add') }}">Creer un compte</a></li> 
                <li><a href="{{ route('admin') }}">Admin/Employer</a></li> 
...
<!--
          <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
            <a href="" class="btn btn-primary btn-lg btn-block btn-icon-split">
              <i class="fas fa-rocket"></i> Nous contacter
            </a>
          </div>
  -->
        </aside>
