              ...
              <div class="card">
                ...
                <div class="card-body">             
                  <ul class="list-unstyled list-unstyled-border">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded-circle" width="50" src="{{ asset('uploads/user/'.$creneau->avatar.'') }}" alt="avatar">
                      <div class="media-body">
                        <div class="float-right text-primary">{{ $creneau->date_heur_debut }}</div>
                        <div class="media-title">{{ $creneau->nom }} {{ $creneau->prenom }}</div>
                        <span class="text-small text-muted">{{ $creneau->note }}</span>
                      </div>
                    </li>
                    @endforeach
                  </ul>
                  <div class="text-center pt-1 pb-1">
                    <a href="{{ route('creneau') }}" class="btn btn-primary btn-lg btn-round">
                      View All
                    </a>
                  </div>
                </div>
