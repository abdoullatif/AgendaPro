        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">Rendez-vous</div>
            </div>
          </div>
          ...
          <div class="section-body">
            ...
            <p class="section-lead">
              Vous avez le liste de tous les creneaux.
            </p>
                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>     
                          ...
                          <tr>
                            ...
                            <td>{{ $creneau->note }}</td>
                            <td>{{ $creneau->date_heur_debut }}</td>
                            <td>{{ $creneau->date_heur_fin }}</td>
                            <td>
                              <img alt="image" src="{{ asset('uploads/user/'.$creneau->avatar.'') }}" class="rounded-circle" width="35" data-toggle="tooltip" title="Wildan Ahdian">
                            </td>
                            <td>{{ $creneau->nom }} {{ $creneau->prenom }}</td>
                            <td>{{ $creneau->email }}</td>
                            <td>{{ $creneau->phone }}</td>
                            @if($creneau->statut == "En attente")
                            <td><div class="badge badge-info">En attente</div></td>
                            @elseif($creneau->statut == "Confirme")
                            <td><div class="badge badge-success">Confirmé</div></td>
                            @else
                            <td><div class="badge badge-danger">Annulé</div></td>
                            @endif
