              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-header">
                    ...
                    <form method="post" action="{{ route('creneau.store.edit', ['id' => $creneau->id]) }}">
                        @csrf                
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control datetimepicker" value="{{ $creneau->date_heur_debut }}" name="date_heur_debut">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control datetimepicker" value="{{ $creneau->date_heur_fin }}" name="date_heur_fin">
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    <input id="note" type="text" value="{{ $creneau->note }}" class="form-control" name="note" autofocus>
                                </div>
                            </div>
