...
<head>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="{{ asset('app-assets/assets/modules/bootstrap-social/bootstrap-social.css') }}">
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="post" action="{{ route('customLogin') }}" class="needs-validation" novalidate="">
                @csrf
                ...
                <div class="text-center mt-4 mb-3">
                  <div class="text-job text-muted">Se connecter avec les réseaux sociaux</div>
                </div>
            ...
            <div class="simple-footer">
              Copyright &copy; Abdoulatif sooba 2023
            </div>
          </div>
        </div>
      </div>
